...
categories = []
for iind, cat in enumerate(voc_clses, start=1):
    cate = {}
...
voc2007xmls = '/home/taowenyin/MyCode/Dataset/FireDetectionVOC/VOC2020/Annotations'
# test_txt = 'voc2007/test.txt'
# test_txt = '/data2/chenjia/data/VOCdevkit/VOC2007/ImageSets/Main/test.txt'
test_txt = '/home/taowenyin/MyCode/Dataset/FireDetectionVOC/VOC2020/ImageSets/Main/train.txt'
